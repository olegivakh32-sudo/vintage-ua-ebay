    ...
    try:
        ...
        inventory_payload = {
            ...
            'conditionDescription': (
                ...
                'Visible age-related wear, scratches and chips. '
                'Sold for restoration, repair, display, or parts. '
            ...
            'product': {
                ...
                'description': (
                    ...
                    'The clock shows age-related wear, scratches and chips. '
                    'A pendulum and two chains are present, and an internal piece '
                    'appears detached. Sold as-is for restoration, repair, display, '
                    'or parts. Please examine all photos carefully for condition '
                    'and completeness.'
                ),
                'aspects': {
                    'Brand': ['Mayak'],
