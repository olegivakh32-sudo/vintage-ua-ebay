...
def _publish_recovery_buttons(label):
    return f"""
    <div style='display:flex;gap:10px;flex-wrap:wrap;margin-top:18px'>
      ...
      <a href='/' style='display:inline-block;padding:12px 16px;border:1px solid #777;border-radius:7px;text-decoration:none'>HOME</a>
    </div>
    """
