...
def picker_editor():
    ...
    return page("Current Lot Photo Editor", f"""
      ...
      <p>FAST SAFE: orientation + gentle light/contrast/colour/sharpness + eBay-ready JPEG. No automatic background cutting, so hair, fur, pale edges, ruler references and visible defects are preserved.</p>
      {status}
      {''.join(cards)}
