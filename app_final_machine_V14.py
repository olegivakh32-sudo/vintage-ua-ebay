...
def picker_editor():
    ...
    for i in range(1, len(items) + 1):
        ...
        <div style='border:1px solid #ddd;border-radius:10px;padding:8px;margin-bottom:14px'>
          ...
          <div style='display:grid;grid-template-columns:1fr 1fr;gap:8px'>
            ...
            <div><b>Optimized for eBay</b><br><img class='edited-preview' src='/picker/edited/{i}?v=14' loading='eager' style='width:100%;max-height:280px;object-fit:contain;background:#f4f4f4'></div>
          </div>
        </div>""")
    ...
    return page("Current Lot Photo Editor", f"""
      ...
      <p>V14 TRUE-COLOR EDITOR: orientation + condition-safe exposure + eBay-ready JPEG. No autocontrast, black crushing, background cutting, defect removal or aggressive colour/contrast changes; texture, patina, scratches and ruler references are preserved.</p>
      {status}
      {''.join(cards)}
    ...
    for i in range(1, len(items) + 1):
        ...
        for attempt in range(2):
            try:
                ...
                PHOTO_EDIT_CACHE.pop((picker_id, i, 1600), None)
