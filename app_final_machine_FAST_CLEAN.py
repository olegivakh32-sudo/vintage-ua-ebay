...
def _safe_photo_edit(image_bytes, fast_clean=True):
    ...
    1-24 photos substantially faster. Defects and ruler references stay real.
    """
...
def picker_edited(index):
    try:
        data = _download_picker_photo(index, edited=True, max_side=800)
    ...
    for i in range(1, len(items) + 1):
        ...
        for attempt in range(2):
            try:
                ...
                PHOTO_EDIT_CACHE.pop((picker_id, i, 2400), None)
