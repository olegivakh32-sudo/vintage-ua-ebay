...
def _safe_photo_edit(image_bytes):
    ...
    # Production FAST editor: preserve the photographed object and its fine edges exactly.
    # Do NOT run automatic background segmentation here: hair, fur, transparent parts and
    # pale vintage plastics can be mistaken for background.  A clean original is safer
    # than destructive masking.  We only apply reversible photographic corrections.
    ...
    # Mild global tonal cleanup makes the approved preview visibly cleaner while
    # preserving the photographed object, wear, patina, hair and ruler references.
...
def picker_editor():
    ...
    for i in range(1, len(items) + 1):
        ...
        <div style='border:1px solid #ddd;border-radius:10px;padding:8px;margin-bottom:14px'>
          ...
          <div style='display:grid;grid-template-columns:1fr 1fr;gap:8px'>
            ...
            <div><b>Optimized for eBay</b><br><img class='edited-preview' src='/picker/edited/{i}?v=13' loading='eager' style='width:100%;max-height:280px;object-fit:contain;background:#f4f4f4'></div>
          </div>
        </div>""")
    ...
    return page("Current Lot Photo Editor", f"""
      ...
      <p>V13 SAFE EDITOR: orientation + automatic tonal cleanup + light/contrast/colour/sharpness + eBay-ready JPEG. No destructive background cutting; hair, fur, pale edges, ruler references, patina and visible defects are preserved.</p>
      {status}
      {''.join(cards)}
